...
public:
	...
	virtual void OnInitializeScene() override
	{
		...
		SceneManager::Instance()->GetCamera()->SetPosition(Vector3(-15.5f, 2.0f, 0.f));
		SceneManager::Instance()->GetCamera()->SetPitch(0.0f);
		SceneManager::Instance()->GetCamera()->SetYaw(-90.f);
		...
		m_Sphere->Physics()->SetAngularVelocity(Vector3(20, 0, 0));
	...
	void ResetScene(float timestep)
	{
		...
		m_Sphere->Physics()->SetLinearVelocity(Vector3(1.0f, 1.0f, -1.0f));
