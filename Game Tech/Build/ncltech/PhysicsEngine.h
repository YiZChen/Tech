...
public:
	...
	void SetTextureState(bool t)		{ this->m_IsDrawTexture = t; }

	void SetShieldState(bool s)			{ this->m_IsShieldUp = s; }
	void SetForce(bool f)				{ this->m_IsUseForce = f; }
